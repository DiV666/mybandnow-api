...
import { SongAuthorizationRepository } from '@Contexts/Song/domain/repository/SongAuthorizationRepository.js';
...
import { SongTitle } from '@Contexts/Song/domain/value-object/SongTitle.js';
...
const persistenceRepository: SongPersistenceRepository = container.get('Song.SongRepository');
const authorizationRepository: SongAuthorizationRepository = container.get('Song.SongRepository');
