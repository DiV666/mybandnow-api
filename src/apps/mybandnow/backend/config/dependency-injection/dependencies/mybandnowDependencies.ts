...
import { register as registerMusicianCreator } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/musician/musicianCreator.dependency.js';
import { register as registerMusicianFindById } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/musician/musicianFindById.dependency.js';
import { register as registerBandCreator } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandCreator.dependency.js';
import { register as registerBandListMembers } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandListMembers.dependency.js';
import { register as registerBandMemberAdder } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandMemberAdder.dependency.js';
import { register as registerBandUpdater } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandUpdater.dependency.js';
import { register as registerBandRemover } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandRemover.dependency.js';
import { register as registerBandFinder } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandFinder.dependency.js';
import { register as registerBandMatcher } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandMatcher.dependency.js';
import { register as registerBandSongInstrumentReassignmentGateway } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandSongInstrumentReassignmentGateway.dependency.js';
import { register as registerBandMemberRemover } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/band/bandMemberRemover.dependency.js';
import { register as registerSongInstrumentBandMembershipGateway } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentBandMembershipGateway.dependency.js';
import { register as registerSongInstrumentBandMemberReassigner } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentBandMemberReassigner.dependency.js';
import { register as registerSongInstrumentAssigner } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentAssigner.dependency.js';
import { register as registerSongInstrumentEditor } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentEditor.dependency.js';
import { register as registerSongInstrumentInviter } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentInviter.dependency.js';
import { register as registerSongInstrumentCreator } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentCreator.dependency.js';
import { register as registerSongInstrumentFindById } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentFindById.dependency.js';
import { register as registerSongInstrumentMatcher } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument/songInstrumentMatcher.dependency.js';
import { register as registerDeletePreviousSongInstrumentVideo } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-video/deletePreviousSongInstrumentVideo.dependency.js';
import { register as registerSongInstrumentVideoCreator } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-video/songInstrumentVideoCreator.dependency.js';
import { register as registerSongInstrumentVideoUpdateStartTime } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-video/songInstrumentVideoUpdateStartTime.dependency.js';
import { register as registerSongInstrumentUploadRequestUploadUrl } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-upload/songInstrumentUploadRequestUploadUrl.dependency.js';
import { register as registerSongInstrumentUploadConfirmUpload } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-upload/songInstrumentUploadConfirmUpload.dependency.js';
import { register as registerSongInstrumentUploadCancelUpload } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-upload/songInstrumentUploadCancelUpload.dependency.js';
import { register as registerSongInstrumentUploadStatusUpdater } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song-instrument-upload/songInstrumentUploadStatusUpdater.dependency.js';
import { register as registerInstrumentsFinder } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/instruments/instrumentsFinder.dependency.js';
import { register as registerInstrumentsMatcher } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/instruments/instrumentsMatcher.dependency.js';
import { register as registerInstrumentsUpdater } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/instruments/instrumentsUpdater.dependency.js';
...
import { register as registerSongMatcher } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song/songMatcher.dependency.js';
import { register as registerSongFindById } from '@Apps/mybandnow/backend/config/dependency-injection/use-cases/song/songFindById.dependency.js';
