...
import { register as registerBandMemberDeleteRemoveController } from '../controllers/band/bandMemberDeleteRemove.dependency.js';
...
import { register as registerSongInstrumentUploadPostUploadCancelController } from '../controllers/songInstrumentUpload/songInstrumentUploadPostUploadCancel.dependency.js';
...
export function registerAppsDependencies(container: ContainerBuilder) {
  ...
  registerBandMemberDeleteRemoveController(container);
  ...
  registerSongInstrumentUploadPostUploadCancelController(container);
