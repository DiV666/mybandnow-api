...
import ProfileGetController from '../../../../controllers/musician/ProfileGetController.js';

export const register = (container: ContainerBuilder) => {
  container
    .register('Apps.Mybandnow.Backend.controllers.ProfileGetController', ProfileGetController)
