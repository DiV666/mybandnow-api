...
import BandMemberPostCreateController from '../../../../controllers/band/BandMemberPostCreateController.js';

export const register = (container: ContainerBuilder) => {
  container
    .register('Apps.Mybandnow.Backend.controllers.BandMemberPostCreateController', BandMemberPostCreateController)
